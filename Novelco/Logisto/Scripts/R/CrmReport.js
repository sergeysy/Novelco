var CrmReportViewModel = function (source, options) {
	var model = this;
	...
	model.TotalDuration = ko.observable(source.TotalDuration);
	// Справочники
	...
	model.ApplyFilter = function () {
		...
		$.ajax({
			...
			success: function (response) {
				...
				model.TotalDuration(temp.TotalDuration());
...
$(function () {
	ko.applyBindings(new CrmReportViewModel(modelData, {
